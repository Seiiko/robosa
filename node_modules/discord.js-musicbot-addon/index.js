...
module.exports = function(client, options) {
  ...
  musicbot.play = (msg, suffix) => {
    ...
    if (msg.member.voiceChannel === undefined) return msg.channel.send(musicbot.note('fail', `You need to be in a voice channel to play music.`));
  ...
  musicbot.search = (msg, suffix) => {
    musicbot.dInvoker(msg);
    // Make sure the user is in a voice channel.
    if (msg.member.voiceChannel === undefined) return msg.channel.send(musicbot.note('fail', `You need to be in a voice channel to search for music.`));
